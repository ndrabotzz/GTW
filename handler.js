...
await conn.sendMessage(jid, text, 'conversation', { quoted: ftroli, thumbnail: await (await fetch('https://telegra.ph/file/fcaea82e59569e40317b8.jpg')).buffer(), contextInfo:{ mentionedJid: [user], externalAdReply: {title: action === 'add' ? 'WELCOME' : 'GOOD BYE', sourceUrl: '', body: '──────────────', thumbnail: fs.readFileSync('./sticker/Images1.jpg')}}})
...
"headerType": "DOCUMENT", "documentMessage": {
      ...
      case 'demote':
        ...
        if (chat.detect) this.send2ButtonLoc(jid, banp, text, 'Indra Bot', 'MENU', '#menu', 'OWNER', '#owner', null, {
          contextInfo: {
...
let fot = `Made by @${'6282228302341'.split('@')[0]}`
  let msg = {
    rowner: '*CREATOR ONLY*',
    owner: '*OWNER ONLY*',
    mods: '*MODERATOR ONLY*',
...
▸ Contoh : #daftar ${user}.13`*/
  ...
  if (msg) return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          ...
          "buttonText": "Indra BOT",
          "listType": "SINGLE_SELECT",
          "sections": [
                            {
                                "rows": [{
                                         "title": `MY OWNER`,
                                         "description": "List Owner Indra BOT",
                                         "rowId": ".nowner"
                                    }, {
                                         "title": `ABOUT`,
                                         "description": " Tentang Indra BOT", 
                                         "rowId": ".info"
                                    }, {
                                         "title": `LIST MENU`,
                                         "description": " List Menu Indra BOT",
                                         "rowId": ".menu"
                                    }, {
                                         "title": `SCRIPT`,
                                         "description": " Source code Indra BOT",
                                         "rowId": ".sc"
                                         }, {
                                         "title": `GROUP BOT`,
                                         "description": " List Group Official Indra BOT",
                                         "rowId": ".gcbot"
                       }],
